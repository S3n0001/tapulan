...
export const IconButton = forwardRef<HTMLButtonElement, IconButtonProps>(function IconButton(
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "inline-flex shrink-0 items-center justify-center rounded-[var(--r-control)] text-muted transition-[color,background-color,transform] duration-[var(--dur-1)] active:scale-95 active:duration-[var(--dur-0)] hover:bg-surface-2 hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color-mix(in_oklab,var(--ring)_55%,transparent)] disabled:pointer-events-none disabled:opacity-55",
